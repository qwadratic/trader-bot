    ...
    def handle(self, **options):
        ...
        txts = [{'name': 'user-start', 'text': 'Добро пожаловать!', 'text_ru': 'Добро пожаловать!'},
                ...
                {'name': 'order-enter_currency_rate',
                 'text': 'Введите желаемую стоимость {trade_currency} в {user_currency}\r\n\r\nСредняя цена за {trade_currency}: {price} {user_currency}',
                 'text_ru': 'Введите желаемую стоимость {trade_currency} в {user_currency}\r\n\r\nСредняя цена за {trade_currency}: {price} {user_currency}'},
                ...
                {'name': 'trade-enter_amount_for_trade', 'text': 'Введите желаемую сумму для обмена',
                 'text_ru': 'Введите желаемую сумму для обмена'}, {'name': 'trade-confirm_amount_for_trade',
                                                                   'text': 'Вы желаете {type_operation} {amount} {payment_currency} за {price_trade} {trade_currency}',
                                                                   'text_ru': 'Вы желаете {type_operation} {amount} {payment_currency} за {price_trade} {trade_currency}'},
